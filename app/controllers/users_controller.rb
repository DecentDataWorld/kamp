class UsersController < ApplicationController
  ...
  def index
    ...
    @member_role = User.joins(:users_organizations, :organizations, :roles).includes(:users_organizations, :organizations, :roles, :users_roles, :organization_applications).order(created_at: :desc).without_role(:admin)
  end
